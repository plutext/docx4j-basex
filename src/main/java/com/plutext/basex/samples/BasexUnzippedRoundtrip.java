 ...
 *
 */
public class BasexUnzippedRoundtrip extends AbstractSample {
...
//			= new com.plutext.basex.xmldb.BasexXMLDBUnzippedPartStore("/db2", "admin", "admin");
...
//			= new com.plutext.basex.webdav.BasexWebdavMiltonUnzippedPartStore("/db2", "admin", "admin");
			= new com.plutext.basex.rest.BasexRESTUnzippedPartStore("/db2", "admin", "admin");
