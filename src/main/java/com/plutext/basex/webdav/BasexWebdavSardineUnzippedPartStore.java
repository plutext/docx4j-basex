 ...
 * @author jharrop
 */
public class BasexWebdavSardineUnzippedPartStore implements PartStore {
	
	private static Logger log = Logger.getLogger(BasexWebdavSardineUnzippedPartStore.class);
	
	private static String URI = "http://localhost:8984/webdav";
	...
	public BasexWebdavSardineUnzippedPartStore(String docxColl, String user, String password) throws Docx4JException {
...
//		String url = URI + docxColl + partPrefix + "/" + partName;
		...
		try { 						
			...
			if (is==null) {
				System.err.println("Couldn't get is!");
			} else {
